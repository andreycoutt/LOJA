...
void imprimirDados(char dados[200]){
    system("cls");
    printf("Cidade:  \nBairro:  \nRua:  "); //cidade bairro e rua
    printf("\n\n~~   ~~"); //nome da empresa
    printf("  ");//falar sobre a empresa
    puts("\n\n");
}
void imprimirMenu(char menu[250]){
    int opcoes;
    printf("TRABALHO FINAL DO 1° PERIODO DE PROGRAMAÇÃO DO CURSO DE SISTEMAS DE INFORMAÇÃO.");
    system("cls");
    printf("\n<+-+-+-+-+-+-+-+-+-+-+-+-+-+-+>");
    printf("\n|                             |*>");
    printf("\n|       SEJA BEM-VINDO        |*>");
...
char curruculo(){
 int i,j,opi,opii;
    ...
    printf("Envie seu curriculo para ~~ ou ~~ \n");//e-mail p onde o curriculo será enviado
    printf("Entraremos em contato em no máximo uma semana, caso voce tenha sido escolhido(a). BOA SORTE!!!");
    }else {
    return main();
    }
    decisao(opi);
...
void smarthpones(struct Produtos p[30]){
 system("cls");
    strcpy(p[0].nome,"Smartphone - Samsung Galaxy J5 Prime");

    strcpy(p[1].nome,"Smartphone - Samsung Galaxy J8");

    strcpy(p[2].nome,"Smartphone - Asus zenfone 5");

    strcpy(p[3].nome,"Smartphone - Iphone 6s");

    strcpy(p[4].nome,"Smartphone - Iphone 7 plus");

    strcpy(p[5].nome,"Smartphone - Iphone X plus");
...
void televisores(struct Produtos p[30]){
system("cls");
    strcpy(p[12].nome,"TV - Smart TV LED 43 Philco Full HD");

    strcpy(p[13].nome,"TV - Smart TV LED 50 Philco FULL HD");

    strcpy(p[14].nome,"TV - Smart TV LED 32 SONY FULL HD");

    strcpy(p[15].nome,"TV - Smart TV 43 LG FULL HD");

    strcpy(p[16].nome,"TV - Smart TV LED 32 Samsumg HD");
...
void games(struct Produtos p[30]){
    ...
    strcpy(p[17].nome,"Jogo - FIFA 19 - XBOX ONE");

    strcpy(p[18].nome,"Jogo - Grand Theft Auto V - XBOX ONE");

    strcpy(p[19].nome,"Jogo - Pro Evolutiion Soccer 19 - XBOX ONE");

    strcpy(p[20].nome,"Jogo - God Of War III - PS4");

    strcpy(p[21].nome,"Jogo - Mortal Kombat X - PS4");
...
do{
    ...
    printf("Digite 1 para Smartphones\nDigite 2 para Notebooks\nDigite 3 para Smart Tvs\nDigite 4 para Jogos\nDigite 5 para Livros\nOpcao: ");
    scanf("%d",&pr);
    strcpy(p[0].nome,"Smarthphone - Samsung Galaxy J5 Prime");
    p[0].valor = 599.00;
    p[0].ref = 1535;

    strcpy(p[1].nome,"Smarthphone - Samsung Galaxy J8");
    p[1].valor = 1036.00;
    p[1].ref = 1536;

    strcpy(p[2].nome,"Smarthphone - Asus Zenfone 5");
    p[2].valor = 1345.00;
    p[2].ref = 1537;

    strcpy(p[3].nome,"Smarthphone - Iphone 6s");
    p[3].valor = 1799.00;
    p[3].ref = 1538;

    strcpy(p[4].nome,"Smarthphone - Iphone 7 Plus");
    p[4].valor = 2879.00;
    p[4].ref = 1539;

    strcpy(p[5].nome,"Smarthphone - Iphone X Plus");
    p[5].valor = 3459.00;
    p[5].ref = 1540;
    ...
    strcpy(p[19].nome,"Jogo - Pro Evolutiion Soccer 19 - XBOX");
    p[19].valor = 121.32;
    p[19].ref = 1554;
